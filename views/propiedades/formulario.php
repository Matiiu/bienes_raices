<fieldset>
    <legend>Información Genral </legend>
...
<fieldset>
    ...
    <legend>Infomración Propiedad</legend>
    ...
    <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ej: 3" min="0" max="9" value="<?php echo s($propiedad->estacionamiento); ?>">
</fieldset>
...
<fieldset>
    ...
    <select name="propiedad[vendedorId]" id="vendedor">
        <option selected value="" hidden > -- Seleccione -- </option>
